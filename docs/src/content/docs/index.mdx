---
title: Tesseron
description: An accessibility layer for AI agents. Expose typed app actions to MCP-compatible agents over WebSocket. No browser automation, no scraping.
related:
  - overview/quickstart
  - overview/why
...
hero:
  tagline: |
    An accessibility layer for AI agents. Expose the typed actions your app
    already has to any MCP-compatible agent over WebSocket — no browser
    automation, no scraping, no Playwright.
  image:
  ...
  actions:
    ...
    - text: Protocol spec
      ...
      variant: secondary
    - text: GitHub
      link: https://github.com/eigenwise/tesseron
      icon: external
      variant: minimal
---
