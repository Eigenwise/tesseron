...
- [`7b9236a`](https://github.com/BrainBlend-AI/tesseron/commit/7b9236a9c4dd2f6a0d493d8b9e96c59a58be96a8) by Kenny - fix(mcp, core): route around dead-transport sessions in the bridge selector (closes [#92](https://github.com/BrainBlend-AI/tesseron/issues/92))
  ...
  implement it are treated as live (preserves pre-[#92](https://github.com/BrainBlend-AI/tesseron/issues/92) behaviour for those
  transports).
...
- [#72](https://github.com/BrainBlend-AI/tesseron/pull/72) [`8f1d94d`](https://github.com/BrainBlend-AI/tesseron/commit/8f1d94df78478f597803855ccb0a0186b592140b) Thanks [@KennyVaneetvelde](https://github.com/KennyVaneetvelde)! - Improve agent recovery when a claimed session is invalidated mid-conversation (closes [#69](https://github.com/BrainBlend-AI/tesseron/issues/69)).

  When a browser session is replaced by a fresh-hello (after an `@tesseron/react` resume race per [#68](https://github.com/BrainBlend-AI/tesseron/issues/68), a manual reload, or any other condition that invalidates the prior session), agent-side MCP tools that hold a cached claim previously got a flat `No claimed session found for app "<id>".` error with no actionable recovery path. The agent's reflex of retrying `tesseron__claim_session` with the previously-known code also failed, leaving the user to read the new claim code from the app UI and paste it back manually.
...
- [#55](https://github.com/BrainBlend-AI/tesseron/pull/55) [`f0e671f`](https://github.com/BrainBlend-AI/tesseron/commit/f0e671f1c26195cc597ce90cb2ad8f8f59dd7e9f) Thanks [@KennyVaneetvelde](https://github.com/KennyVaneetvelde)! - Add `tesseron/claimed` notification (gateway → SDK) so apps can clear the spent claim code from their UI once an agent has redeemed it.
